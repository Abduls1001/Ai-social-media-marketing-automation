...
interface CampaignsErrorStateProps {
  message?: string;
}

export function CampaignsErrorState({ message }: CampaignsErrorStateProps) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 py-24 text-center">
      ...
      <div className="max-w-md">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Something went wrong while fetching your campaigns. Please try
          refreshing the page.
        </p>
        {message && (
